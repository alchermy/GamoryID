...
export const ACTIVITY_LABELS: Record<string, string> = {
  ...
  "credit.top_up_reversed": "ยกเลิกอนุมัติเครดิต (ดึงเครดิตคืน)",
  ...
  "shop.branding_updated": "อัปเดตโลโก้/แบนเนอร์ร้าน",
  "shop.onboarding_dismissed": "ปิดคู่มือเริ่มต้นใช้งาน",
  "shop.retagged": "ปรับรหัสไอดีทั้งร้าน",
  ...
  "security.two_factor_disabled": "ปิด 2FA",
  "security.two_factor_recovery_regenerated": "สร้างรหัสสำรอง 2FA ใหม่",
  "auth.terms_accepted": "ยอมรับข้อกำหนดการใช้งาน",
