...
const DISCORD_COMMAND_GUIDE = [
  ["/ร้าน เมนู", "โพสต์แผงปุ่มควบคุมและปักหมุดไว้ในห้องคำสั่ง", "สมาชิกที่เชื่อมบัญชี"],
  ["/ร้าน ค้นหา", "ค้นหาไอดีจากแท็ก", "จัดการสต็อก หรือ จองและขาย"],
  ["/ร้าน สรุป", "ดูภาพรวมสต็อกและยอดขายของร้าน", "สมาชิกที่เชื่อมบัญชี"],
  ["/ร้าน รายการ", "ดูรายการไอดีล่าสุดตามสถานะ", "จัดการสต็อก หรือ จองและขาย"],
  ["/ร้าน จอง", "จองไอดีให้ลูกค้าตามระยะเวลาที่กำหนด", "จองและขาย"],
  ["/ร้าน ยกเลิกจอง", "ยกเลิกการจองและคืนสถานะพร้อมขาย", "จองและขาย"],
  ["/ร้าน ปิดการขาย", "บันทึกข้อมูลลูกค้าและปิดการขายไอดี", "จองและขาย"],
  ["/ร้าน โน้ต", "บันทึกโน้ตเตือนความจำไว้กับไอดี", "จัดการสต็อก หรือ จองและขาย"],
  ["/ร้าน เพิ่มไอดี", "เพิ่มไอดีใหม่โดยไม่ส่งข้อมูลลับผ่าน Discord", "จัดการสต็อก"],
  ["/ร้าน ช่วยเหลือ", "ดูคำสั่งที่บัญชีของคุณมีสิทธิ์ใช้งาน", "สมาชิกที่เชื่อมบัญชี"],
] as const;
          ...
          <div className="discord-connected-body">
            ...
            >
              ...
              <div className="discord-command-catalog">
                {DISCORD_COMMAND_GUIDE.map(([command, description, permission]) => (
                  <div key={command}>
                    <code>{command}</code>
                    <p>{description}</p>
                    <span>ต้องมีสิทธิ์: {permission}</span>
                  </div>
                ))}
              </div>
              <div className="discord-command-safety" role="note">
                ...
                <span>
                  คำสั่งเพิ่มไอดีรับได้ถึงชื่อผู้ใช้ แต่ไม่รับรหัสผ่าน
