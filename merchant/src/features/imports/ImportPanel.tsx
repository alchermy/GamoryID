            ...
            {preview && (
              ...
              >
                ...
                <div className="import-confirm-row">
                  <p>
                    Username ซ้ำกับไอดีเดิมในร้านนำเข้าได้ (ไอดีที่ขายไปแล้ว
                    กลับมาลงขายซ้ำได้) · แถวที่รหัสไอดี (Tag) ซ้ำ
                    หรือ username ซ้ำกันเองในไฟล์ จะถูกข้ามแล้วนำเข้าที่เหลือ ·
                    แถวที่ข้อมูลไม่ถูกต้อง (เช่น ราคาไม่ใช่ตัวเลข)
